...
public class User {
    ...
    @Column(unique = true)
    @Schema(title = "사용자 이메일", description = "사용자 이메일이 겹치지 않게 해줍니다.")
    ...
    @Schema(title = "사용자 주소", description = "사용자 주소를 넣어주시면 됩니다.")
    private String address;

    @Column(unique = true)
    @Schema(title = "사용자 이미지 경로", description = "사용자 이미지 경로를 넣어주시면 됩니다.")
